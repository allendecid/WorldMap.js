...
var regionnames={
  "US": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/us.json",
  "CL": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/chile.json",
  "AR": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/argentina.json",
  "BR": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/brazil.json",
  "ES": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/espana.json",
  "JP": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/japan.json",
  "DE": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/germany.json",
  "CN": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/china.json",
  "GB": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/uk.json",
  "IT": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/italy.json",
  "IN": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/india.json",
  "INdistricts": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/indiadistricts.json",
  "FR": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/france.json",
  "PK": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/pakistan.json",
  "NL": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/netherlands.json",
  "IE": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/ireland.json",
  "ZA": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/southafrica.json",
  "DK": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/denmark.json",
  "TR": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/turkey.json",
  "PT": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/portugal.json",
  "SE": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/sweden.json",
  "NZ": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/newzealand.json",
  "PH": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/philippines.json",
  "FI": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/finland.json",
  "PL": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/poland.json",
  "DZ": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/algeria.json",
  "AZ": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/azerbaijan.json",
  "PE": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/peru.json",
  "MX": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/mexico.json",
  "RU": "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/russia.json",
  false: "https://raw.githubusercontent.com/allendecid/WorldMap.js/master/topojson/worldtemplate.json"
  ...
  $(document).ready(function () {$(settings.elementid).append('<div id="progress_bar"><div class="percent">0%</div></div><div class="container demo" id="containerdemo"><!-- Modal --><div class="modal left fade" id="'+newid+'myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="myModalLabel">Table & Plugins</h4></div><div class="modal-body">                                    <div id="info"></div>        <select id="plugin" class="selectpicker" data-width="fit">  <option value="default">Plugins</option>  <option value="cloropleth">Cloropleth</option>  <option value="circles">Bubble</option>  <option value="pulse">Pulse</option>  <option value="text">Text</option>  <option value="arcs">Arcs</option>  <option value="barchart">Barchart</option>  <option value="stackedbar">StackedBar</option></select>                                                                 <select id="category" class="selectpicker" multiple data-width="fit" title="Location">                      </select>                                                       <div id="appendable"></div>        <button type="button" id="addplugin" class="btn btn-secondary">Add</button>        <button type="button" id="adv" class="btn btn-secondary">Advanced</button>        <button type="button" id="reset" class="btn btn-secondary">Reset</button>                <div id="advanced" style="display: none;"><label>Settings:</label> <br>             <select id="colorcolumn" class="selectpicker" data-width="fit">            <option value="color">ColorColumn</option>          </select>        <select id="sizecolumn" class="selectpicker" data-width="fit">            <option value="size">SizeColumn</option>          </select><input type="checkbox" id="anim" value="animate" > <label for="anim">Animate</label> <button type="button" id="savesvg" class="btn btn-secondary">Save SVG</button>         <br><br>FillColor: <input id="top" class="jscolor" value="4682b4">        <div id="custom" style="display: none;"> <input id="font" type="text" /> </div>       </div>        <br><br><table id="datatable-responsive" class="table table-striped table-bordered responsive no-wrap" cellspacing="0" width="100%"></table>    </div></div><!-- modal-content --></div><!-- modal-dialog --></div><!-- modal --><!-- Modal --><div class="modal right fade" id="'+newid+'myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="myModalLabel2">Draw & Edit</h4></div><div class="modal-body"><div id="menu8">  Select Style:     <select id="stylesel" class="selectpicker" data-width="fit">            <option value="default">Default</option>            <option value="soft">Soft</option>            <option value="blackwhite">Black and White</option>            <option value="greyscale">Greyscale</option>            <option value="classic">Classic</option>            <option value="paper">Paper</option>            <option value="strong">Strong</option>            <option value="doom">Doom</option>       </select> <br> <br>                                             Load file:     <span id="load"><input type="file" class="upload" id="files" /></span>     <p>Draw: <button id="target" class="btn btn-secondary">Polygon</button>    <button id="other" class="btn btn-secondary">Line</button>    <button id="point" class="btn btn-secondary">Bubble</button></p>    Edit: <button id="delete" class="btn btn-secondary">Delete</button>    <button id="save" class="btn btn-secondary">Save</button>    <button id="finish" class="btn btn-secondary">Apply</button><br>    <br>Color&nbsp;    &nbsp;<p><input class="jscolor" value="000000"></p>&nbsp;    &nbsp;LineSize: <span id="nRadius-value"></span>&nbsp;    &nbsp;<input type="range" id="nRadius" step="0.05" min="0" max="12" value="2" class="slider-width100">&nbsp;    &nbsp;PointRadius: <span id="pRadius-value"></span>&nbsp;    &nbsp;<input type="range" id="pRadius" step="0.1" min="0.01" max="16" value="3" class="slider-width100">&nbsp;    <br>    &nbsp;<input type="checkbox" id="removepath" value="1">Hide regions<br>&nbsp;    &nbsp;<input type="checkbox" id="addnames" value="1">Show names<br>&nbsp;    &nbsp;<input type="checkbox" id="addgraticule" value="1">Show graticule<br>&nbsp;  </div></div></div><!-- modal-content --></div><!-- modal-dialog --></div><!-- modal --></div><!-- container --><div class="map"><div class="text-center">                        <input type="button" value="Table" class="rotate"  data-toggle="modal" data-target="#'+newid+'myModal"/>            <input type="button" value="Edit" class="rotate2"  data-toggle="modal" data-target="#'+newid+'myModal2"/></div><div id="playeranim" class="play-button" style="display: none;"></div><span id="showinfo"></span></div>');});
   ...
   function loadlocal(error,world){
    ...
    function loaded(error, world,dataload) {
     ...
     $(settings.elementid).width(settings.width).height(settings.height);
...
var svg = d3.select(settings.elementid+" .map").append("svg")
    .attr("width", settings.width)
    .attr("height", settings.height);
    
  var div = d3.select(settings.elementid+" .map").append("div")
    .attr("class", "tooltip")
    .style("opacity", 0);    
     ...
     var points=formatgeo(dataload, "circle",settings);
      ...
      case "pulse": 
        ...
        var points=formatgeo(dataload, "circle",settings);
             ...
             dopulse(g, points, projection,settings);
      break;
      case "text": 
      ...
      case "arcs": 
         var arcdata=findCoordinatesByAttribute(features,dataload);
             ...
             fly2(h,arcdata, projection,settings);
      break;
      case "barchart": 
          setkeys("location");
...
if(settings.showtable&&(settings.dataurl||settings.plugin))var Table= new drawtable(dataload,headers,settings.elementid);
else{$('.rotate').css('display', 'none');}
if(!settings.editpanel)$('.rotate2').css('display', 'none');
if(settings.player)$('#playeranim').css('display', 'block');
...
$('#stylesel').on('change', function() {
  ...
  switch(field) {
      case "default":
      $(settings.elementid+' .ocean').css('fill', '#5F8791');
      $(settings.elementid+' .map').css('background-color', '#5F8791');
      ...
      break;    
      case "soft":     
      $(settings.elementid+' .ocean').css('fill', '#D0E8EA');
      $(settings.elementid+' .map').css('background-color', '#D0E8EA');
      ...
      break;      
      case "blackwhite":
      $(settings.elementid+' .ocean').css('fill', '#0E001C');
      $(settings.elementid+' .map').css('background-color', '#0E001C');
      ...
      break;
      case "greyscale":
      $(settings.elementid+' .ocean').css('fill', '#ABABAB');
      $(settings.elementid+' .map').css('background-color', '#ABABAB');
      ...
      break;
      case "classic":
      $(settings.elementid+' .ocean').css('fill', '#A3CDFF');
      $(settings.elementid+' .map').css('background-color', '#A3CDFF');
      ...
      break;
      case "paper":
      $(settings.elementid+' .ocean').css('fill', '#E9F0FF');
      $(settings.elementid+' .map').css('background-color', '#E9F0FF');
      ...
      break;
      case "strong":
      $(settings.elementid+' .ocean').css('fill', '#4A5B62');
      $(settings.elementid+' .map').css('background-color', '#4A5B62');
      ...
      break;
      case "doom":
      $(settings.elementid+' .ocean').css('fill', '#24282B');
    //  $(settings.elementid+' .map').css('background-color', '#24282B');
...
switch(settings.dataType) {
    ...
    case "csv":
        queue().defer(d3.json, regionnames[settings.region])
...
if(!isNaN(data[0][key[1]])){datatype=1;
...
var domain=[minval,(rangeval/4).toFixed(2),(rangeval/2).toFixed(2),(3*rangeval/4).toFixed(2),maxval];
 ...
 // .data(topojson.object(map, map.objects.russia).geometries)
  ...
  .style("fill", function(d) {var check=$.inArray(d[identify], array);if(check>-1){
         if(!datatype){if(typeof data[check].color === 'undefined')return settings.colorscale(data[check][key[1]]);else return data[check].color;}
...
function addcircles(g,fpuntos,projection){
 ...
 function dopulse(g,fpuntos,projection,settings){
  g.selectAll("circle")
		.data(fpuntos).enter()
		.append("circle")
                .attr("class", 'circle')
...
d3.select(settings.elementid).selectAll("svg").remove();
...
function drawtable(source,headers,elementid){
...
$(document).ready(function() {
  ...
  var table =  $(elementid+' #datatable-responsive').DataTable( {
        retrieve: true,
        data: data,
        columns: headerNames,
        "pageLength": 25,
  ...
  switch(plugin) {
     ...
     var points=formatgeo(data, "circle",newsett);
      ...
      case "pulse": 
              ...
              newsett.dataurl=false;
        var points=formatgeo(data, "circle",newsett);
        dopulse((this.getg()), points, (this.getprojection()),newsett);
      break;
      case "text": 
      ...
      case "arcs": 
         var arcdata=findCoordinatesByAttribute((this.getfeatures()),data);
            ...
            fly2((this.geth()),arcdata, (this.getprojection()),(this.getsettings()));
      break;
      case "barchart": 
          setkeys("location");
